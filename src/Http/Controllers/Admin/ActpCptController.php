...
class ActpCptController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('cms-dashboard::admin.actp.cpt.index', compact('postTypes'));
    }
    ...
    {
        return view('cms-dashboard::admin.actp.cpt.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('cms-dashboard::admin.actp.cpt.edit', compact('postType'));
    }
