    ...
    <script>
        ...
        document.addEventListener('click', async function(e) {
            if (e.target.classList.contains('add-term-ajax-btn')) {
                ...
                try {
                    let url = "{{ $type }}" === 'post' && (taxonomy === 'categories' || taxonomy === 'tags' || taxonomy === 'category') 
                    ...
                    if (data.id) {
                        ...
                        const inputName = (taxonomy === 'categories' || taxonomy === 'category' || taxonomy === 'tags' ) && "{{ $type }}" === 'post' ? 'categories[]' : 'tax_terms[]';
